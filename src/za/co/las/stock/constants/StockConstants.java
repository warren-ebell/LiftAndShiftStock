...
public class StockConstants {
	...
	public static final String GET_ALL_SOLD_STOCK_FOR_REPORT = "getAllSoldStockForReport";
	public static final String EXPORT_ALL_SOLD_STOCK_FOR_REPORT = "exportAllSoldStockForReport";

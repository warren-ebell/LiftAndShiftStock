...
public class StockService {
	...
	public int updateStockItem(int stockId, double pricing, String stockManufacturer, String stockModel, String stockSeries, String stockCode, String technicalSpecs, String description, int used, double markup, double shipping) {
	...
	public int createStockItem(double pricing, String stockManufacturer, String stockModel, String stockSeries, String stockCode, String technicalSpecs, String description, int used, double markup, double shipping) {
		Stock stock = new Stock();
		stock.setStockManufacturer(stockManufacturer);
		stock.setStockModel(stockModel);
		stock.setStockSeries(stockSeries);
